...
def get_setting(name, default=None, settings=local_settings):
    ...
    if default is None:
        raise ImproperlyConfigured("Missing default value for '{0}'".format(name))
    ...
    # If nothing is found return the default setting
        ...
        if default is not None:
            ...
            raise ImproperlyConfigured("Missing setting for '{0}' setting".format(name))
...
CORS_ORIGIN_WHITELIST = ["http://134.174.140.208:9000"]
...
SNIPPET_IMG_MAX_OUT_DIM = get_setting("SNIPPET_IMG_MAX_OUT_DIM", 1024)
SNIPPET_OSM_MAX_DATA_DIM = get_setting("SNIPPET_OSM_MAX_DATA_DIM", 2048)
SNIPPET_IMT_MAX_DATA_DIM = get_setting("SNIPPET_IMT_MAX_DATA_DIM", 2048)
